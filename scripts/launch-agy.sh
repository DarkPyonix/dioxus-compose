...
cd "$tree"
: > "$log"
# The working directory is named in the prompt as well as entered here. Two agy runs
# started with this script did their work in the main checkout instead of the worktree
# they were given: they created the branch there, switched it twice while another worker
# was committing, and left that worker's two commits on two different unrelated branches.
