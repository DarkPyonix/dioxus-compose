#!/usr/bin/env bash
# Usage: ./scripts/split-branches.sh [--write] [--source BRANCH] [--target BRANCH]
#
...
tmp_index="$(mktemp -t dxc-split-index.XXXXXX)"
...
message+=$'\n\n'
message+="Generated by scripts/split-branches.sh. The internal planning documents"
message+=$'\n'
