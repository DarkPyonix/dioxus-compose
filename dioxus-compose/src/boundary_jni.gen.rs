...
#[unsafe(no_mangle)]
pub extern "system" fn Java_dioxus_compose_ui_platform_HostBridge_nativeNoop(
    _env: JNIEnv<'_>,
    _class: JClass<'_>,
) -> jint {
    STATUS_OK
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_dioxus_compose_ui_platform_HostBridge_nativeNoopFast(
    _env: JNIEnv<'_>,
    _class: JClass<'_>,
) -> jint {
    STATUS_OK
